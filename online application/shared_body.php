    ...
    ?>
            <div id="main" style="border-left: 1px solid #ebebeb">
              <div class="col-md-12">
                ...
                <?php
                    $query = mysql_query("select * from files INNER JOIN data_shared ON files.data_id = data_shared.data_id where data_shared.user_id='$user_id' ORDER BY  files.data_type ASC, files.data_name ASC", $connection);
                    $pos= 0;
